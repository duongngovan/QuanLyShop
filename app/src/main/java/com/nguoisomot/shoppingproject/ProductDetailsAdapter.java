...
public class ProductDetailsAdapter extends FragmentPagerAdapter {
    ...
    public ProductDetailsAdapter(FragmentManager fm, int totalTabs, String productDescription, String productOtherDeatails, List<ProductSpecificationModel> productSpecificationModelList) {
        super(fm);
    ...
    public Fragment getItem(int i) {
        switch (i) {
            ...
            case 2:
                ...
                productDescriptionFragment2.body = productOtherDeatails;
