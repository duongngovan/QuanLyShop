...
public class ResetPasswordFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        emailIcon = view.findViewById(R.id.forgot_passwrod_email_icon);
        emailIconText = view.findViewById(R.id.forgot_passwrod_email_icon_text);
        progressBar = view.findViewById(R.id.forgot_passwrod_progressbar);
