...
public class WishlistAdapter extends RecyclerView.Adapter<WishlistAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull WishlistAdapter.ViewHolder viewHolder, int position) {
        ...
        String resoure = wishlistModelList.get(position).getProductImage();
        ...
        viewHolder.setData(productId, resoure, title, freeCoupens, rating, totalRatings, productPrice, cuttedPrice, paymentMethod, position);
